...
function formType(id) {
    ...
    switch (id) {
        ...
        case 'planText': {
            formBox.innerHTML = '<textarea name="planText" id="planText" class="form-control d-flex m-auto" cols="30" rows="10" placeholder="User ID" ></textarea>';
            break;
        }
        // case 'siteUrl': {
...
function QRCodeGenerator() {
    ...
    attractiveQR_Generator(element,userInput);
}
